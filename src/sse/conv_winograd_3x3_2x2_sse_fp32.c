...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_3x3_2x2_sse_fp32_nhwc_pre
#else
void conv_winograd_3x3_2x2_sse_fp32_nchw_pre
#endif
  ...
  #pragma omp parallel for collapse(2) private(ik,ic,F0,F1,W0,W1,W2,W3,U0,U1,U2,U3,i) if ((k * c) > 1)
  for (ik = 0; ik < k; ik++)
    for (ic = 0; ic < c; ic++) {
...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_3x3_2x2_sse_fp32_nhwc_kernel
#else
void conv_winograd_3x3_2x2_sse_fp32_nchw_kernel
#endif
...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_3x3_2x2_sse_fp32_nhwc
#else
void conv_winograd_3x3_2x2_sse_fp32_nchw
#endif
        (int m, int r, int n, int k, int c,
         int hi, int wi, int kh, int kw,
         int vpadding, int hpadding,
...
#ifdef TENSOR_FORMAT_NHWC
    conv_winograd_3x3_2x2_sse_fp32_nhwc_pre
#else
    conv_winograd_3x3_2x2_sse_fp32_nchw_pre
#endif
        (m, r, n, k, c, kh, kw, F, ldF1, ldF2, ldF3, U);

#ifdef TENSOR_FORMAT_NHWC
    conv_winograd_3x3_2x2_sse_fp32_nhwc_kernel
#else
    conv_winograd_3x3_2x2_sse_fp32_nchw_kernel
#endif
