...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_2x2_5x5_sse_fp32_nhwc_pre
#else
void conv_winograd_2x2_5x5_sse_fp32_nchw_pre
#endif
...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_2x2_5x5_sse_fp32_nhwc_kernel
#else
void conv_winograd_2x2_5x5_sse_fp32_nchw_kernel
#endif
...
#ifdef TENSOR_FORMAT_NHWC
void conv_winograd_2x2_5x5_sse_fp32_nhwc
#else
void conv_winograd_2x2_5x5_sse_fp32_nchw
#endif
        (int m, int r, int n, int k, int c,
         int hi, int wi, int kh, int kw,
         int vpadding, int hpadding,
...
#ifdef TENSOR_FORMAT_NHWC
    conv_winograd_2x2_5x5_sse_fp32_nhwc_pre
#else
    conv_winograd_2x2_5x5_sse_fp32_nchw_pre
#endif
        (m, r, n, k, c, kh, kw, F, ldF1, ldF2, ldF3, U);

#ifdef TENSOR_FORMAT_NHWC
    conv_winograd_2x2_5x5_sse_fp32_nhwc_kernel
#else
    conv_winograd_2x2_5x5_sse_fp32_nchw_kernel
#endif
